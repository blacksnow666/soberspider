...
CREATE TABLE `ref_procurement_numbering` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `module` (`module`,`company_code`,`ptj_code`,`month_year`),
  KEY `ptj_code` (`ptj_code`),
  KEY `company_code` (`company_code`),
  CONSTRAINT `ref_procurement_numbering_ibfk_1` FOREIGN KEY (`ptj_code`) REFERENCES `ref_ptj` (`id`),
  CONSTRAINT `ref_procurement_numbering_ibfk_2` FOREIGN KEY (`company_code`) REFERENCES `ref_company` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2012-10-01 11:53:56
